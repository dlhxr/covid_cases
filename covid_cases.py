...
trans_jhu = ['US','United Kingdom','United Arab Emirates','Korea, South','China']
trans_bbg = ['U.S.','U.K.','UAE','South Korea','Mainland China']

#dictionary to translate country names
trans_en = ['US','United Kingdom','India','Brazil','Russia','Colombia','Peru','Mexico','Spain','Argentina','South Africa','France','Chile','Iran','Bangladesh','Iraq','Saudi Arabia','Turkey','Pakistan','Italy','Philippines','Germany','Portugal','Indonesia','Czechia','Poland','Ukraine','Malaysia','United Arab Emirates','Japan','Belgium','Netherlands','Korea, South','Vietnam','Austria','China','Australia']
trans_cn = ['美国','英国','印度','巴西','俄罗斯','哥伦比亚','秘鲁','墨西哥','西班牙','阿根廷','南非','法国','智利','伊朗','孟加拉','伊拉克','沙特','土耳其','巴基斯坦','意大利','菲律宾','德国','葡萄牙','印尼','捷克','波兰','乌克兰','马来西亚','阿联酋','日本','比利时','荷兰','韩国','越南','奥地利','中国','澳大利亚']
